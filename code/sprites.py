...
class Gun(pygame.sprite.Sprite):
    def __init__(self, player, groups):
        ...
        # Scale down from 2000x2000 to something reasonable like 20x20 or 30x30
        lasergun_size = 150  # Adjust this to make it bigger/smaller
...
class Home(pygame.sprite.Sprite):
    def __init__(self, pos, groups):
        ...
        home_size = (384, 384)  # Adjust based on your sprite size
